const productApi = 'https://raw.githubusercontent.com/GeekBrainsTutorial/online-store-api/master/responses/catalog.json';
...
const CompProducts = {
  ...
  created() {
    this.$root
      ...
      .then((data) => {
        for (let el of data) {
          let prod = Object.assign({ quantity: 1, imgProduct: 'http://placehold.it/350x300' }, el);
